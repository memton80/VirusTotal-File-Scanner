...
(function initOnboarding() {
  ...
  const btnNext3 = document.getElementById('onboarding-next-3');
  const btnPrev4 = document.getElementById('onboarding-prev-4');
  ...
  if (btnPrev4) {
    btnPrev4.addEventListener('click', () => {
      ...
      positionHighlights();
      const apiKeyCard = document.querySelector('.card:has(#api)');
      if (apiKeyCard) apiKeyCard.scrollIntoView({ behavior: 'smooth', block: 'center' });
    });
  }
